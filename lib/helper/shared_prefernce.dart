...
//     String userDataJson = json.encode(userData);
//     await prefs.setString(_userDataKey, userDataJson);
//     await setLoginState(true);  // Ensure that the login state is set to true
//     print('User data stored: $userData');
//   }
//
//   // Method to retrieve user data
...
//   }
//
//   // Clear session (only clear user data, keep login state as true)
//   static Future<void> clearSession() async {
//     final prefs = await SharedPreferences.getInstance();
//     // Clear user data but keep the login state
//     await prefs.remove(_userDataKey);
//     print('Session cleared but login state maintained.');
//   }
// }
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:convert';
